...
public class AttributeDisplayScreen extends Screen {
    ...
    int midY = 0;
    int midX = 0;
    ResourceLocation bg = new ResourceLocation(Constants.MOD_ID, "textures/gui/attr_abil_bg.png");
    ResourceLocation bar = new ResourceLocation(Constants.MOD_ID, "textures/gui/cooldownbars.png");
    ...
    protected void drawRowForAttribute(String type, int y, PoseStack stack, int mouseX, int mouseY) {
        ...
        if (isInWidthRange && isInHeightRange) {
            ...
            this.renderTooltip(stack, tooltipLines, Optional.empty(), mouseX, mouseY, font);
        }
